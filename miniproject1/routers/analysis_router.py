...
from service.analysis_service import (get_class_summary, get_student_status_service, 
...
def get_attend_graph(db: Session = Depends(get_db)):
...
def get_student_status_res(db: Session = Depends(get_db)):
