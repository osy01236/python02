...
#json 에서 car, truck, person의 갯수 그래프로 그리기
with open("18396603_frame_20.json","r", encoding='utf-8') as f:
    data = json.load(f)

#car , truck, person 객체별 몇개?
...
#
# #픽셀 값 분포 히스토리그램 그래프 만들기
# plt.figure(figsize = (10,4))
#
# #이미지 밝기 분포를 히스토그램으로 보여주기
# #ravel()은 2차원 이미지를 1차원으로 제공하기 위해 사용
# #히스토그램은 2차원 배열이 아닌 1차원배열 형태가 필요하기 떄문에
# # bins256 은 0~255까지 256칸으로 나누기  위한것(그래야 분포를 자세히 볼수있다)
